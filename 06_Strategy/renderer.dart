...
/// our abstract [Renderer] which is the strategy interface contract
///
abstract class Renderer {
  /// our main abstract method which will provide a render-able widget back
  /// to the caller
  Widget render();
}
...
///
/// You could provide a constructor which accepts an initialization string with
